...
JNIEXPORT jint JNICALL Java_cn_edu_hust_buildingtalkback_jni_NativeInterface_initVideo(JNIEnv *env, jclass clazz, jint width, jint height);

JNIEXPORT void JNICALL Java_cn_edu_hust_buildingtalkback_jni_NativeInterface_sendVideo(JNIEnv *env, jclass clazz, jbyteArray data, jint buffer_size);
